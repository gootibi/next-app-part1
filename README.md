...
- Using Third-Party Scripts:
                Put exp.: in .tsx file the code
                    ...
                    Create in layout.tsx:
                                    ...
                                    <html lang="en" data-theme="winter">
                                        <GoogleAnalyticsScript /> // Put here between html and body elements.
...
- Using fonts: 
    1. Import Google Fonts: 
        In layout.tsx: 
                        ...
                        ...
                        <body className={roboto.className}> {/* Set roboto font with Google */}
                        ...

    2 Import Local Fonts:
        Create folder: root/public/fonts
        Put here the file: poppins-regular-webfont.woff2 - example file
        In layout.tsx: 
                ...
        ...
        globalcss: 
                ...
                ...
        Or put page in exp. <h1 className='font-poppins'>
...
- Search Engine Optimization:
    ...
    In page, Give metadata about the page:
